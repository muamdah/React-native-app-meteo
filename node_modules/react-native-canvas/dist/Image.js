...
var Image = (_dec = (0, _webviewBinders.webviewProperties)({
  ...
  src: undefined,
  width: undefined
}), _dec2 = (0, _webviewBinders.webviewEvents)(['load', 'error']), _dec3 = (0, _webviewBinders.webviewConstructor)('Image'), _dec(_class = _dec2(_class = _dec3(_class = function Image(canvas, width, height) {
  var _this = this;

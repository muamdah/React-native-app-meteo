...
var createObjectsFromArgs = function createObjectsFromArgs(args) {
  for (var index = 0; index < args.length; index += 1) {
    ...
    if (currentArg.className !== undefined) {
      ...
      var _constructor = _construct(constructors[className], _toConsumableArray(classArgs));

      args[index] = _constructor;
    }
  }
...
function handleMessage(_ref) {
  ...
  switch (type) {
    ...
    case 'construct':
      {
        var _constructor2 = payload.constructor,
            _target2 = payload.id,
        ...
        var object = _construct(constructors[_constructor2], _toConsumableArray(newArgs));

        object.__constructorName__ = _constructor2;
